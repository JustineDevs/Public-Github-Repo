...
Search the project (e.g. `.cursor/rules/CO-STAR-UI-CREATOR/`, `.cursor/command/ui-template/CO-STAR-UI-CREATOR/`, or elsewhere). Once you have their paths (initial data), **then** proceed with the steps below. Do not skip this step.
